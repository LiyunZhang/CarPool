...
//Driver form
(function($){
	$.fn.driverForm=function(options){
	   return this.each(function(){
		  var $this = $(this),
		  data = $this.data('driverForm'),
		  object = {
			 url: 'booking/booking.php', // php-script url
			 sender: '', // sender for header in e-mail
			 ownerEmail:'support@carpool.com', // destination e-mail, message will be send on this e-mail
			 validate:true, // validate or not
			 errorMessageClass:'.error-message', // error-message class
			 successMessageClass:'.success-message', // success-message class
			 invalidClass:'.invalid', // invalid class
			 inputClass: '.tmInput', // input class
			 textareaClass: '.drTextarea', // textarea class
			 selectClass: '.drSelect', // select class
			 checkboxClass: '.drCheckbox', // checkbox class
			 radioClass: '.drRadio', // radiobutton class
			 datepickerClass: '.drDatepicker', // datepicker class
			 wrapperClass: '.controlHolder', // wrapper class, all elements will be wrapped in div with this class
			 successMessage: "Thank you! Your credentials will be reviewed and you will be e-mailed once your status is updated.", // success message
			 // private fields
			 form: null,
			 fields: [],
			 types: {input: 'input', textarea: 'textarea', select: 'select', checkbox: 'checkbox', radio: 'radio', datepicker: 'datepicker'},
		  ...
		  data ? object=data : $this.data({driverForm: object});
		   typeof options=='object' && $.extend(object, options);
		   object.data || object.init(object.data = $this);
	   })
	   return this;
